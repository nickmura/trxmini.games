...
contract Escrow {
    ...
    event Testing(uint index, address player1, address player2, bool firstStake, bool secondStake);
    ...
    function payDraw(uint index) public {
        ...
        emit Testing(index, Games[index].playerOne, Games[index].playerTwo, Games[index].stake0, Games[index].stake1);
    }
