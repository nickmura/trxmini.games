<script lang="ts">
    ...
    const trxDomainBadge = {
		name: '.trx Domain Holder',
        bio: `${$fetchedProfile.username} is an early supporter of trxmini.games.`,
        img: '/img/trx_domains_medal.png',
        rarity: 'Rare',
        description: `The <b>'.trx Domain Holder'</b> badge/token is given to those who currently hold a TRX domain. Thank you for
        supporting a partner of ours and the ecosystem. You can use your trx domain as a username.`,
	}
        ...
        <div class="flex flex-col rounded-xl bg-[#1E1E32] hover:scale-[1.05] transition transition-300">
            <div class="p-4">
                ...
                <div class="flex items-center justify-center pt-3">
                    <img src={badge.img} alt="" class="h-32 w-32" />
                </div>
